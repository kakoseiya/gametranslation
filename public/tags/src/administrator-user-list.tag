            ...
            <table class="table table-hover col-md-12">
                ...
                <tr class="row">
                    <th onclick="{_func.sortDocumentList}" id="sort_origText"
                        ref="origText" class="list-pointer col-md-4">
                        ユーザー名
                    ...
                    <th onclick="{_func.sortDocumentList}" id="sort_remarks"
                        ref="remarks" class="list-pointer col-md-2">
                        状態
                        <span class="{status.sortIcon[2]}" aria-hidden="true" aria-label="Right Align"></span>
                    </th>
                    <th onclick="{_func.sortDocumentList}" class="col-md-3">
                ...
                <tr each="{item, i in status._data}"
                    ...
                    <th onclick="{modal.modalOn}" class="col-md-4"
                    ...
                    <th class="col-md-3">
                        <button class="btn btn-primary btn-sm" id="admin_{item.publicId}"
                                onclick="{_func.editUser}">
                                <span class="glyphicon glyphicon-wrench" aria-hidden="true"
                                      aria-label="Right Align"
                                      id="adminspan_{item.publicId}"
                                ></span>
                            編集
                        </button>
                        <button class="btn btn-primary btn-sm" id="delete_{item.publicId}" onclick="{_func.deleteUser}">
