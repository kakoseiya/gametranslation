 ...
 * ゲスト以外の権限認証
 */
public class NoGuestAuth extends AccountsAuth {
    final static private String className = "NoGuestAuth";
    ...
    public String getUsername(Http.Context context) {
        ...
        if (null == cookie) {
            ...
            if (cache != null && cache instanceof GtSession) {
                ...
                if (UserPrivileges.GUEST.equals(gtSession.getUserPrivileges())) {
                    return null;
                }
